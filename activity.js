...
// 1
const addEntry = (new_title, new_author) => {
    bookList.push({title : new_title, author: new_author});
};

//2 
const removeBook = (remove_title, remove_author) => {
    delete bookList.remove_title;
